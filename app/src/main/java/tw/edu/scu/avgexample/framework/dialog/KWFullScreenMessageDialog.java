...
public class KWFullScreenMessageDialog {
    ...
    public KWFullScreenMessageDialog(Context context){
    ...
    protected void initDialog() {
        this.dialog = new KWBaseDialog(this.context, R.style.MessageDialog) {
            ...
            public boolean dispatchTouchEvent(MotionEvent event)
            {
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    KWSoundManager.sharedInstance(KWFullScreenMessageDialog.this.context).playSound(R.raw.kw_sound_button_click);

                    if (KWFullScreenMessageDialog.this.typewriterTextView.isFinishAnimation()) {
                        KWFullScreenMessageDialog.this.onClickListener.onClick(this, 0);
                    }
                    else {
        ...
        this.dialog.setContentView(R.layout.kw_full_screen_message_dialog);
        ...
        this.typewriterTextView.setTypewriterFinishListener(new KWTypewriterTextView.KWTypewriterFinishListener() {
            ...
            public void animationDidFinish() {
                KWFullScreenMessageDialog.this.dialogHintIGifmageView.setVisibility(View.VISIBLE);
            }
        });
    ...
    public KWFullScreenMessageDialog show(String message){
        updateDialogMessage(message, this.colorString);
        return this;
    }

    public KWFullScreenMessageDialog show(String message, String colorString){
        updateDialogMessage(message, colorString);
        return this;
    }

    public KWFullScreenMessageDialog dismiss() {
        this.dialog.dismiss();
        return this;
    }
    ...
    private void updateDialogMessage(String message) {
        updateDialogMessage(message, "#FFFFFF");
    }

    private void updateDialogMessage(String message, String colorString) {

        ((KWTypewriterTextView)this.dialog.findViewById(R.id.dialogMessageTextView)).setTextColor(Color.parseColor(colorString));

        KWFullScreenMessageDialog.this.dialogHintIGifmageView.setVisibility(View.GONE);
    ...
    private void updateMessageImmediately() {
        KWFullScreenMessageDialog.this.typewriterTextView.animateTextImmediately(this.message);
        KWFullScreenMessageDialog.this.dialogHintIGifmageView.setVisibility(View.VISIBLE);
