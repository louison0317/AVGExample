...
public class SampleEndScene_3_Activity extends KWBaseSceneActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sample_end_scene_3);
    }
    ...
    private void initEvents() {
        SampleEndScene_Utils.end_3(this, this.eventManager);
    }
    ...
    protected void didFinishAllEvent (String eventIdentifier){
        ...
        if ( "結局場景3".equals(eventIdentifier)) {
            showEndHint();
        }
    }
