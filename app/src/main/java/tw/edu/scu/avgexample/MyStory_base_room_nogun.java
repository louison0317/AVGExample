...
public class MyStory_base_room_nogun extends KWBaseSceneActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_story_base_room_nogun);
    ...
    protected void initializeEvent () {
        ...
        MyStory_baseroom_nogun_Utils.scene_1_1(this, this.eventManager);
    }
    ...
    protected void didFinishAllEvent (String eventIdentifier){
        ...
        if ( "救".equals(eventIdentifier)) {
            MyStory_baseroom_nogun_Utils.scene_1_5(this, this.eventManager);
        }
        else if ( "不救".equals(eventIdentifier)) {
            switchSceneActivity(End_nosave_nogun.class);
        }
    ...
    private void button_box() {
        MyStory_baseroom_nogun_Utils.scene_1_2(this, this.eventManager);
    }
    @Override
    protected void onOptionSelected (String identifier, int index){
        ...
        if ("打開保險箱選項".equals(identifier)) {
            ...
            switch (index) {
                case 0:
                    MyStory_baseroom_nogun_Utils.scene_1_4(this, this.eventManager);
                    break;
                case 1:
                    MyStory_baseroom_nogun_Utils.scene_1_3(this, this.eventManager);
                    break;
            }
        ...
        if ("精神病1選項".equals(identifier)) {
            ...
            switch (index) {
                case 0:
                    ...
                    break;
                case 1:
                    MyStory_baseroom_nogun_Utils.scene_1_6(this, this.eventManager);
                    break;
            }
        ...
        if ("精神病2選項".equals(identifier)) {
            ...
            switch (index) {
                case 0:
                    ...
                    break;
                case 1:
                    switchSceneActivity(End_save_nogun.class);
                    break;
            }
