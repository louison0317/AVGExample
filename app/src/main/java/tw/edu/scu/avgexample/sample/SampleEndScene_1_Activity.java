...
public class SampleEndScene_1_Activity extends KWBaseSceneActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sample_end_scene_1);
    }
    ...
    private void initEvents() {
        SampleEndScene_Utils.end_1(this, this.eventManager);
    }
    ...
    protected void didFinishAllEvent (String eventIdentifier){
        ...
        if ( "結局場景1".equals(eventIdentifier)) {
            showEndHint();
        }
    }
