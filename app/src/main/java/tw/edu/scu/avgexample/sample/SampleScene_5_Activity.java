...
public class SampleScene_5_Activity extends KWBaseSceneActivity {
    ...
    protected void initializeEvent () {
        ...
        SampleScene_5_Utils.scene_5_1(this, this.eventManager);
    }
    ...
    protected void didFinishAllEvent (String eventIdentifier){
        ...
        if ( "場景5-1".equals(eventIdentifier)) {
            switchSceneActivity(SampleScene_6_Activity.class, R.anim.kw_scene_animation_scale_in_down, R.anim.kw_scene_animation_scale_out_up);
